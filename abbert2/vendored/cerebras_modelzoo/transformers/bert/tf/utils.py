...
import yaml
from abbert2.vendored.cerebras_modelzoo.common.model_utils.vocab_utils import get_vocab_size
from abbert2.vendored.cerebras_modelzoo.common.run_utils import is_cs
...
def set_defaults(params, mode=None):
    ...
    if params["model"].get("use_vsl") and mode != "train":
        ...
        tf.compat.v1.logging.warn("VSL not used outside of train mode.")
...
def get_custom_stack_params(params):
    ...
    if (
        ...
        config.placement.place.max_fc_delta_ratio = 3.0
        ...
        if runconfig_params["mode"] == "eval":
            ...
            config.matching.match_kernels.disabled_converters.append(
